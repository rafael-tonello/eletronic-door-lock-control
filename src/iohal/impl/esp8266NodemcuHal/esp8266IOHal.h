...
public:
    ESP8266IOHal() {
        availableIos[IOHAL_A0] = IHAL_PIN_INFO{IOHAL_A0, DPM_INPUT, PPM_UNKNOWN};
        availableIos[IOHAL_D0] = IHAL_PIN_INFO{IOHAL_D0, DPM_DUPLEX, PPM_UNKNOWN};
        availableIos[IOHAL_D1] = IHAL_PIN_INFO{IOHAL_D1, DPM_DUPLEX, PPM_UNKNOWN};
        availableIos[IOHAL_D2] = IHAL_PIN_INFO{IOHAL_D2, DPM_DUPLEX, PPM_UNKNOWN};
        availableIos[IOHAL_D3] = IHAL_PIN_INFO{IOHAL_D3, DPM_DUPLEX, PPM_UNKNOWN};
        availableIos[IOHAL_D4] = IHAL_PIN_INFO{IOHAL_D4, DPM_DUPLEX, PPM_UNKNOWN};
        availableIos[IOHAL_D5] = IHAL_PIN_INFO{IOHAL_D5, DPM_DUPLEX, PPM_UNKNOWN};
        availableIos[IOHAL_D6] = IHAL_PIN_INFO{IOHAL_D6, DPM_DUPLEX, PPM_UNKNOWN};
        availableIos[IOHAL_D7] = IHAL_PIN_INFO{IOHAL_D7, DPM_DUPLEX, PPM_UNKNOWN};
        availableIos[IOHAL_D8] = IHAL_PIN_INFO{IOHAL_D8, DPM_DUPLEX, PPM_UNKNOWN};
